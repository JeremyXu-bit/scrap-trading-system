<template>
  <div class="login-container">
    ...
    >
      ...
      <p class="forgetPsw" @click="forgetPsw">忘记密码？</p>
      <el-row :gutter="20">
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-button :loading="loading" type="primary" style="width:100%" @click.native="register">注册</el-button>
          </div>
        </el-col>
        <el-col :span="12">
      ...
      <!-- <div style="padding-right:5px;width: 50%;display:inline-block">
      </div>
      <div style="padding-left:5px;width: 50%;display:inline-block;float: right;">
      </div> -->
    </el-form>
  </div>
</template>
