  ...
  <div class="dashboard-container">
    <el-form ref="form" :model="form" label-width="100px">
      ...
      <el-form-item>
        ...
        <el-button type="primary" plain @click="dialogTableVisible2 = true">出库</el-button>
      </el-form-item>
    </el-form>
    ...
    <template>
      <div>
        <el-dialog title="确认出库" :visible.sync="dialogTableVisible2">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button type="primary" @click="dialogTableVisible2 = false;dialogFormVisible2 = true">下一步</el-button>
          </div>
        </el-dialog>
      </div>
    </template>
